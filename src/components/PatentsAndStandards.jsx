...
const PatentsAndStandards = ({ toggleTheme, isDarkMode, toggleFullScreen }) => {
    ...
    return (
        <div className="flex flex-col w-full min-h-screen bg-[#f8fafc] dark:bg-ndl-dark transition-colors duration-500">
            ...
            {/* Hero Header */}
            <div className="relative pt-20 pb-12 px-[5%] text-center overflow-hidden bg-gradient-to-b from-[#e3f2fd] to-transparent dark:from-ndl-dark dark:to-transparent">
                    ...
                    <div className="w-full max-w-5xl relative group mb-12 animate-fadeInUp">
                        ...
                        <div className="relative bg-white dark:bg-gray-800 border-2 border-transparent focus-within:border-accent shadow-2xl rounded-[1.5rem] flex p-1 transition-all duration-500 overflow-hidden">
                            <div className="px-8 flex items-center border-r border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-gray-900/20">
                                <span className="text-xs font-black uppercase tracking-widest text-[#1a237e] dark:text-[#90caf9] flex items-center gap-3">
                                    📜 IP Registry
                                </span>
                            </div>
                            <input
                        ...
                        >
                                    ...
                                    {section.items.map((item, itemIdx) => (
                                        ...
                                        >
                                            <div
                                                ...
                                                onClick={() => alert(`Opening patent/standard document: ${item}`)}
                                            >
                            ...
                            <div className="px-12 py-6 bg-gray-50/50 dark:bg-black/30 border-t border-gray-100 dark:border-white/5 flex justify-center group-hover:bg-accent/10 transition-colors duration-500">
                                <button
                                    ...
                                    className="flex items-center gap-4 text-xs font-black uppercase tracking-[0.4em] text-[#1a237e] dark:text-[#90caf9] hover:text-[#0d47a1] transition-all group/btn"
                                >
